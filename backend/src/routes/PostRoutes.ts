...
class PostRoutes {
    ...
    constructor() {
        ...
        this._Router.post("/public/update/:id", SessionController.isUser, upload.single("image"), PostController.updatePublic);
        ...
        this._Router.post("/group/update/:id", SessionController.isUser, upload.single("image"), PostController.updateGroup);
